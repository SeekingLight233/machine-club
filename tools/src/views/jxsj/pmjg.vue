  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="n" label="活动构件数n=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="pi" label="低副数目Pl=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="ph" label="高副数目Ph=" label-float></mu-text-field>
          </div>
        </div>
        <div class="buttons">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/pmjg.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let pi = parseFloat(this.pi);
      let ph = parseFloat(this.ph);
      let result = 3*n-2*pi-ph;
