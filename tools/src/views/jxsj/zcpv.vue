  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="f" label="轴承承受的径向载荷F=" label-float>N</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="b" label="轴承有效宽度B=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="d" label="轴径直径d=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="n" label="轴颈转速n=" label-float>r/min</mu-text-field>
          </div>
        </div>
        <div class="buttons">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">非液体润滑滑动轴承(轴承pv值)=</h3>
          <div id="res">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/zcpv.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = (f/(b*d))*((Math.PI*n*d)/(60*1000))
