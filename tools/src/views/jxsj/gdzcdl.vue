  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="x" label="轴承径向载荷系数X=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="y" label="轴向载荷系数Y=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="fr" label="轴承所受的径向载荷FR=" label-float>N</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="fa" label="轴向载荷FA=" label-float>N</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/gdzcdl.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let fr = parseFloat(this.fr);
      let fa = parseFloat(this.fa);
      let result = x*fr + y*fa;
