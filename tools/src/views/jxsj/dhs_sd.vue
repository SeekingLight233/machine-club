  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="qv" label="液压泵供给液压缸的流量qv=" label-float>m3/s</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="d" label="活塞杆直径d=" label-float>m</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">单活塞杆液压缸差动连接时的速度v3=</h3>
          <div id="res">
            <font color="#f44336">{{res}}</font>
            <h3 class="myh3" v-if="show">m/s</h3>
          </div>
        </div>
      </div>
    </mu-paper>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/dhs_sd.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
