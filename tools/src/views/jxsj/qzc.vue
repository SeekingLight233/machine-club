  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="P" label="轴承载荷(当量载荷)P"  label-float>N</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="C" label="基本额定动载荷C"  label-float>N</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="n" label="轴承转速n"  label-float>rpm</mu-text-field>
          </div>
        </div>
        <div class="buttons">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="https://www.jixieclub.com:3002/images/qzc.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
export default {
  ...
  methods: {
    cal() {
      ...
      var result = 1000000/(60*n*(Math.pow(C/P,3)))
