  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="qv" label="通过油管的实际流量qv=" label-float>m^3/s</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="v" label="管内允许油液流动的速度v=" label-float>m/s</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/gz_nj.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = 2*Math.sqrt(qv/(Math.PI*v));
