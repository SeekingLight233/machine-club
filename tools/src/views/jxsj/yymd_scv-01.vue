  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="qb" label="液压泵的输出流量qb=" label-float>L/min</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="vm" label="液压马达的排量Vm=" label-float>L/r</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="nvm" label="液压马达的容积效率ηvm=" label-float></mu-text-field>
          </div>
        </div>
        <div class="buttons">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">液压马达的输出转速(在液压泵的输出流量情况下)nM=</h3>
          <div id="res">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/yymd_scv-01.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      let qb = parseFloat(this.qb);
      let vm = parseFloat(this.vm);
      let nvm = parseFloat(this.nvm);
      let result = (qb/vm)*nvm;
