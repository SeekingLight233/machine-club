  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="d" label="管子内径d=" label-float>m</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="p" label="管内油液的工作压力p=" label-float>MPa</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="f" label="材料的许用应力σ=" label-float>MPa</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/gz_bh.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
