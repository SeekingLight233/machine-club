  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="A" label="直线段长度A=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="B" label="直线段长度B=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="a" label="内弯任意角α=" label-float>度</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="R" label="圆角半径R=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="Z" label="板料厚度Zo=" label-float>mm</mu-text-field>
          </div>
        </div>
        <div class="buttons">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">内弯任意角弯曲件展开长度L=</h3>

          <div id="res">
            <font color="#f44336">{{res}}</font>
            <h3 class="myh3" v-if="show">mm</h3>
          </div>
        </div>
      </div>
    </mu-paper>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/nwryj.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = A+B+((Math.PI*a*(R-Z))/180)
