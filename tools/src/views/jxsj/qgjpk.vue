  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="qv" label="工作压力下气缸的耗气量qv=" label-float>m^3/s</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="v" label="空气流经进、排气口的速度v=" label-float>m/s</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/qgjpk.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = Math.sqrt(4*qv / (Math.PI*v));
