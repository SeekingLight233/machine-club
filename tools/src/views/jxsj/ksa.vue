  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="w" label="角速度ω=" label-float>rad/s</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="V" label="相对速度Vr=" label-float>m/s</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">科氏加速度Ac=</h3>

          <div id="res">
            <font color="#f44336">{{res}}</font>
            <h3 class="myh3" v-if="show">m/s2</h3>
          </div>
        </div>
      </div>
    </mu-paper>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/ksa.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;科氏加速度是动基的转动与动点相对运动相互耦合引起的加速度。科氏加速度的方向垂直于角速度矢量和相对速度矢量。</p>
      </div>
    </mu-paper>
  </div>
</template>
