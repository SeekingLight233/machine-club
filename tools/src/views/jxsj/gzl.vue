  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="Z1" label="主动链轮的齿数Z1=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="Z2" label="从动链轮的齿数Z2=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="a" label="初定的中心距a=" label-float>mm</mu-text-field>
          </div>

           <div class="myinput">
            <mu-text-field v-model="p" label="链的节距p=" label-float>mm</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/gzl.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;链的长度是以链的节数来表示的。</p>
      </div>
    </mu-paper>
  </div>
</template>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = ((z1+z2)/2)+((2*a)/p)+(p/a)*((z2-z1)/(2*Math.PI))*((z2-z1)/(2*Math.PI));
