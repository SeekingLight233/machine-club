  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="W" label="施加拉力W=" label-float>N</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="A" label="截面积A=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="n" label="变形伸长量λ=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="l" label="受力前的长度l=" label-float>mm</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">弹性模量E=</h3>

          <div id="res">
            <font color="#f44336">{{res}}</font>
            <h3 class="myh3" v-if="show">Pa</h3>
          </div>
        </div>
      </div>
    </mu-paper>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/txml.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;材料在弹性变形阶段，其应力和应变成正比例关系，其比例系数称为弹性模量。</p>
      </div>
    </mu-paper>
  </div>
</template>
