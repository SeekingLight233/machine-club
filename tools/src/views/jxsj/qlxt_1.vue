  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="λ" label="沿程阻力系数λ=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="L" label="管道长度L=" label-float>m</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="d" label="管道的内径d=" label-float>m</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="v" label="管内压缩空气的平均流速v=" label-float>m/s</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="γ" label="空气的重度γ=" label-float>N/m^3</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="g" label="重力加速度g=" label-float>m/s^2</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">气路系统管道压力损失计算△p=</h3>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/qlxt_1.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
