  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="l" label="原有长度l=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="A" label="伸长或压缩变形量λ=" label-float>mm</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/zxyb.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;材料内任一点因各种作用引起的尺寸或形状发生纵向相对变形，称为应变。</p>
      </div>
    </mu-paper>
  </div>
</template>
