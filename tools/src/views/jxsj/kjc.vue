  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="N" label="槽底至孔面的距离N="  label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="d" label="轴直径d="  label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="b" label="键槽宽度b="  label-float>mm</mu-text-field>
          </div>
        </div>
        <div class="buttons">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/kjc.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = N-(d+Math.sqrt(d*d-b*b))/2;
