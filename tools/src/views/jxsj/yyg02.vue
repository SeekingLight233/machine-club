<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="p" label="液压缸的工作压力p=" label-float>pa</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="qv" label="液压缸流量qv=" label-float>m^3/s</mu-text-field>
          </div>
        </div>
        <div class="buttons">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/yyg02.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在无杆腔侧具有液压缸流量qv情况下</p>
      </div>
    </mu-paper>
  </div>
</template>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let qv = parseFloat(this.qv);
      let result = 10*Math.sqrt((40*qv)/(Math.PI*p));
