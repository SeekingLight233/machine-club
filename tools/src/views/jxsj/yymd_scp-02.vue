  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="pim" label="液压马达的理论功率pim=" label-float>kw</mu-text-field>
          </div>
          <div class="myinput">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">液压马达的输出功率pm=</h3>
          <div id="res">
            <font color="#f44336">{{res}}</font>
            <h3 class="myh3" v-if="show">kw</h3>
          </div>
        </div>
      </div>
    </mu-paper>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/yymd_scp-01.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;液压马达的理论功率</p>
      </div>
    </mu-paper>
  </div>
</template>
