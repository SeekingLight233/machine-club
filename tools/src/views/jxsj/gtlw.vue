  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="k" label="拧紧螺纹系数k=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="f" label="液压缸最大推力F=" label-float>N</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="z" label="螺栓或拉杆的数量Z=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="o" label="螺栓或拉杆材料的许用应力σ=" label-float>MPa</mu-text-field>
          </div>
        </div>
        <div class="buttons">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">缸体螺纹连接的螺纹直径计算d1=</h3>
          <div id="res">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/gtlw.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在没有液压缸内径D的情况下</p>
      </div>
    </mu-paper>
  </div>
</template>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = Math.sqrt((4*1.3*k*f)/(Math.PI*z*o))
