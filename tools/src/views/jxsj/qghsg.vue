  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="f1" label="气缸的推力F1=" label-float>N</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="n" label="活塞杆材料的许用应力σ=" label-float>Pa</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/qghsg.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      let f1 = parseFloat(this.f1);
      let n = parseFloat(this.n);
      let result = Math.sqrt(4*f1 / (Math.PI*n));
