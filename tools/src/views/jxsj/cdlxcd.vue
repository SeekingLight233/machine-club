  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="N" label="螺杆转动圈数N=" label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="pha" label="螺杆a段的螺纹导程Pha=" label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="phb" label="螺杆b段的螺纹导程Phb=" label-float>mm</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">差动螺旋传动计算（旋向相反）L=</h3>
          <div id="res">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/cdlxcd.png" alt width="50%" />
      <div class="center">
        <p class="para">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </mu-paper>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let pha = parseFloat(this.pha);
      let phb = parseFloat(this.phb);

      let result = N*(pha-phb);
