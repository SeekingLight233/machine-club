  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="ic" label="最大距离Ic="  label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="e" label="弹性模量E="  label-float>N/mm²</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="p" label="密度ρ="  label-float>kg/mm³</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">临界转速nc=</h3>
          <div id="res">
            <font color="#f44336">{{res}}</font><h3 class="myh3" v-if="show"> r/min</h3>
          </div>
        </div>
      </div>
    </mu-paper>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/hd36.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此公式用于螺杆横向振动的校核，应使螺杆转速n ≤ 0.8nc。</p>
      </div>
    </mu-paper>
  </div>
</template>
...
export default {
  ...
  methods: {
    cal() {
        ...
        let ic = parseFloat(this.ic);
        let e = parseFloat(this.e);
        let p = parseFloat(this.p);
        
      let result = ((60*u1*u1*i)/(2*Math.PI*ic*ic))*Math.sqrt(e/p)
