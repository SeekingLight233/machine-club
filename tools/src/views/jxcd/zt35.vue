  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="f" label="轴向载荷F="  label-float>N·mm</mu-text-field>
          </div>
          <div class="myinput">
          ...
          <div class="myinput">
            <mu-text-field v-model="a" label="截面面积A="  label-float>mm²</mu-text-field>
          </div>
          <div class="myinput">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此公式用于螺杆刚度的校核。±的取法为：伸长变形为﹢，压缩变形为﹣。</p>
      </div>
    </mu-paper>
  </div>
</template>
