  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="t1" label="外加转矩T1="  label-float>N*m</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="d1" label="分度圆直径d1="  label-float>m</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/yz15.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;蜗杆圆周力与蜗轮轴向力相同，方向相反，Ft1 产生的转矩与外加转矩T1方向相反。</p>
      </div>
    </mu-paper>
  </div>
</template>
