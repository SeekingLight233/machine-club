<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="d2" label="螺纹的中径d2="  label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="v" label="螺旋的导程角γ="  label-float>°</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="pv" label="当量摩擦角ρv="  label-float>°</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/hd22.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
export default {
  ...
  methods: {
    cal() {
        ...
        let pv = parseFloat(this.pv);
        
      let result = 0.5*d2*f*Math.tan(v+pv);
