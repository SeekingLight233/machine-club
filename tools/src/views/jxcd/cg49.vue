<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="f" label="疲劳强度应力σF="  label-float>MPa</mu-text-field>
          </div>
          <div class="myinput">
          ...
          <div class="myinput">
            <mu-text-field v-model="y2" label="状况系数Y2="  label-float></mu-text-field>
          </div>
          <div class="myinput">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/cg49.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;强度条件为 SF≥SFmin</p>
...
export default {
  ...
  methods: {
    cal() {
        ...
        let y2 = parseFloat(this.y2);
        let yx = parseFloat(this.yx);

        
      let result = (fe*yn*y*y2*yx)/f
