<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="z1" label="大齿轮齿数Z1="  label-float>个</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="z2" label="小齿轮齿数Z2="  label-float>个</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="a" label="分度圆柱螺旋角β="  label-float>°</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/wc80.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = m*(z1+z2)/(2*Math.cos(a))
