<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="w" label="系数ψ="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="pp" label="许用比压Pp="  label-float>N/mm²</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/lg25.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
export default {
  ...
  methods: {
    cal() {
        ...
        let pp = parseFloat(this.pp);
        
        
        
      let result = 0.8*Math.sqrt(f/(w*pp));
