<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="h" label="齿顶高系数ha*="  label-float></mu-text-field>
          </div>
          <div class="myinput">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/bz61.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、本公式适用于直齿轮和斜齿轮，对于斜齿轮，用端面参数按公式计算。 2、模数，斜齿轮则为法向模数 mn</p>
      </div>
    </mu-paper>
  </div>
</template>
