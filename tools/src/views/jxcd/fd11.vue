<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/fd11.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;对于 Σ=90°的传动，蜗杆的轴向模数mx与蜗轮的端面模数mt相同，均以 m表示。对于要求自锁的传动，采用 γ小于3°30′。</p>
      </div>
    </mu-paper>
  </div>
</template>
