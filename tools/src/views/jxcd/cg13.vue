<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="ha" label="齿顶高系数ha="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="c" label="顶隙系数c="  label-float></mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/cg13.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、齿顶高系数，一般取为1，短齿取为0.8； 2、顶隙系数，一般取为0.2；</p>
      </div>
    </mu-paper>
  </div>
</template>
...
export default {
  ...
  methods: {
    cal() {
        ...
        let ha = parseFloat(this.ha);
        let c = parseFloat(this.c);
        
        
      let result = d1-(2*m*(ha+c))
