  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="a" label="分度圆压力角α="  label-float>rad</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="x1" label="变位系数x1="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="x2" label="变位系数x2="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="z" label="齿数z1="  label-float></mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">啮合角α*=</h3>
          <div id="res">
            <font color="#f44336">{{res}}</font><h3 class="myh3" v-if="show">rad</h3>
          </div>
        </div>
      </div>
    </mu-paper>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/wc70.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;适用于直齿轮和斜齿轮，对于斜齿轮，用端面分度圆压力角αt 按公式计算，在给定变位系数x的条件下应用。</p>
      </div>
    </mu-paper>
  </div>
</template>
