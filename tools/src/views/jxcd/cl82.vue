  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="db" label="基圆直径db="  label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="da" label="齿顶圆直径da="  label-float>mm</mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/cl82.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;齿顶圆压力角公式对于外啮合、内啮合形式的直齿轮、斜齿轮均适用，具体对于基圆直径和齿顶圆直径的计算不同；</p>
      </div>
    </mu-paper>
  </div>
</template>
...
export default {
  ...
  methods: {
    cal() {
        let db = parseFloat(this.db);
        let da = parseFloat(this.da);
        
      let result = Math.acos(db/da)
