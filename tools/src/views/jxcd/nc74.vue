  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="h" label="齿顶高系数han*="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="x" label="法向变位系数xn1="  label-float></mu-text-field>
          </div>
          <div class="myinput">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/nc74.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
