<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="b" label="齿顶圆压力角αa="  label-float>rad</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="z" label="齿数z="  label-float></mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/bz67.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = (Math.PI/(2*z))+Math.tan(a)+Math.tan(b)-a-b
