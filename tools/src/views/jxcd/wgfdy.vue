  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          <div class="myinput">
            <mu-text-field v-model="z" label="蜗轮齿数Z="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="ahp" label="许用齿面接触应力σHP="  label-float>MPa</mu-text-field>
          </div>
          <div class="myinput">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/wgfdy.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
        >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = Math.pow(15000/(ahp*m*z),2)*k*t2;
