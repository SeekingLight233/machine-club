  ...
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="condition">
          ...
          <div class="myinput">
            <mu-text-field v-model="m" label="模数mn="  label-float>mm</mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="kv" label="动载系数KV="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="khb" label="分配系数KHβ="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="kha" label="分配系数KHα="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="yf" label="复合齿形系数YFS="  label-float></mu-text-field>
          </div>
          <div class="myinput">
            <mu-text-field v-model="y" label="重合度与螺旋角系数Yεβ="  label-float></mu-text-field>
          </div>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      <div class="title">
        ...
        <div class="padding10">
          <h3 class="myh3">弯曲应力σFst=</h3>
          <div id="res">
            <font color="#f44336">{{res}}</font><h3 class="myh3" v-if="show"></h3>
          </div>
        </div>
      </div>
    </mu-paper>
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/zd52.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
...
export default {
  ...
  methods: {
    cal() {
        ...
        let yf = parseFloat(this.yf);
        let y = parseFloat(this.y);
        
      let result = kv*khb*kha*(f/(b*m))*yf*y
