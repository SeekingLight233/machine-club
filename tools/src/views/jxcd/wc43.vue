<template>
  <div class="root">
    ...
    <mu-paper class="demo-paper" :z-depth="4" id="mypaper">
      ...
      <img src="../assets/wc43.png" alt width="50%" /><br>
      <img src="../assets/wc431.png" alt width="50%" />
      <div class="center">
        <p
          class="para"
...
export default {
  ...
  methods: {
    cal() {
      ...
      let result = 447*(u+1)*Math.pow((k*t1)/(a*ahp*ahp*u),1/3)
      console.log(result.toFixed(3));
      this.res = result.toFixed(3).toString();
      this.show = true;
      let result1 = 709*Math.pow(((k*t1)/(d*ahp*ahp))*((u+1)/u),1/3);
