...
Z([[2,'+'],[1,'2-'],[[7],[3,'index']]])
Z([3,'button-group data-v-7da2d0e4'])
Z(z[13])
Z([3,'cu-btn line-cyan shadow my-margin data-v-7da2d0e4'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'pre']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'上一页'])
Z(z[13])
Z([3,'cu-btn bg-cyan shadow data-v-7da2d0e4'])
...
var bUB=_mz(z,'image',['bindtap',2,'class',1,'data-event-opts',2,'mode',3,'src',4],[],e,s,gg)
_(tSB,bUB)
var eTB=_v()
_(tSB,eTB)
if(_oz(z,7,e,s,gg)){eTB.wxVkey=1
var oVB=_mz(z,'input',['focus',-1,'bindblur',8,'bindconfirm',1,'bindinput',2,'class',3,'confirmType',4,'data-event-opts',5,'maxlength',6,'placeholder',7,'type',8,'value',9],[],e,s,gg)
_(eTB,oVB)
}
else{eTB.wxVkey=2
var xWB=_mz(z,'input',['bindblur',18,'bindconfirm',1,'bindinput',2,'class',3,'confirmType',4,'data-event-opts',5,'maxlength',6,'placeholder',7,'type',8,'value',9],[],e,s,gg)
_(eTB,xWB)
}
var oXB=_mz(z,'image',['bindtap',28,'class',1,'data-event-opts',2,'mode',3,'src',4],[],e,s,gg)
_(tSB,oXB)
eTB.wxXCkey=1
_(lQB,tSB)
var aRB=_v()
...
_(o2B,c3B)
var o4B=_mz(z,'image',['bindtap',38,'class',1,'data-event-opts',2,'mode',3,'src',4],[],e,s,gg)
_(o2B,o4B)
_(h1B,o2B)
var l5B=_n('view')
...
var oBC=_mz(z,'view',['bindtap',48,'class',1,'data-event-opts',2],[],b9B,e8B,gg)
var fCC=_oz(z,51,b9B,e8B,gg)
_(oBC,fCC)
_(o0B,oBC)
return o0B
}
a6B.wxXCkey=2
_2z(z,46,t7B,e,s,gg,a6B,'item','index','index')
_(h1B,l5B)
_(fYB,h1B)
}
var cZB=_v()
_(aRB,cZB)
if(_oz(z,52,e,s,gg)){cZB.wxVkey=1
var cDC=_n('view')
_rz(z,cDC,'class',53,e,s,gg)
var hEC=_n('view')
...
var oNC=_mz(z,'view',['bindtap',61,'class',1,'data-event-opts',2],[],tKC,aJC,gg)
var xOC=_oz(z,64,tKC,aJC,gg)
_(oNC,xOC)
_(eLC,oNC)
return eLC
}
oHC.wxXCkey=2
_2z(z,59,lIC,e,s,gg,oHC,'item','index','index')
_(cDC,cGC)
_(cZB,cDC)
}
fYB.wxXCkey=1
...
var cRC=_n('view')
_rz(z,cRC,'class',66,e,s,gg)
var hSC=_n('view')
_rz(z,hSC,'class',67,e,s,gg)
var oTC=_oz(z,68,e,s,gg)
_(hSC,oTC)
var cUC=_mz(z,'image',['bindtap',69,'class',1,'data-event-opts',2,'mode',3,'src',4],[],e,s,gg)
_(hSC,cUC)
_(cRC,hSC)
var oVC=_n('view')
_rz(z,oVC,'class',74,e,s,gg)
var lWC=_v()
_(oVC,lWC)
var aXC=function(eZC,tYC,b1C,gg){
var x3C=_mz(z,'view',['bindtap',79,'class',1,'data-event-opts',2],[],eZC,tYC,gg)
var o4C=_oz(z,82,eZC,tYC,gg)
_(x3C,o4C)
_(b1C,x3C)
return b1C
}
lWC.wxXCkey=2
_2z(z,77,aXC,e,s,gg,lWC,'item','index','index')
_(cRC,oVC)
_(oPC,cRC)
}
var fQC=_v()
...
var f5C=_n('view')
_rz(z,f5C,'class',84,e,s,gg)
var c6C=_n('view')
_rz(z,c6C,'class',85,e,s,gg)
var h7C=_oz(z,86,e,s,gg)
_(c6C,h7C)
_(f5C,c6C)
var o8C=_n('view')
_rz(z,o8C,'class',87,e,s,gg)
var c9C=_v()
_(o8C,c9C)
var o0C=function(aBD,lAD,tCD,gg){
var bED=_mz(z,'view',['bindtap',92,'class',1,'data-event-opts',2],[],aBD,lAD,gg)
var oFD=_oz(z,95,aBD,lAD,gg)
_(bED,oFD)
_(tCD,bED)
return tCD
}
c9C.wxXCkey=2
_2z(z,90,o0C,e,s,gg,c9C,'item','index','index')
_(f5C,o8C)
_(fQC,f5C)
}
oPC.wxXCkey=1
...
var lOD=_mz(z,'zy-search',['bind:__l',1,'class',1,'isBlock',2,'isFocus',3,'showWant',4,'vueId',5],[],e,s,gg)
_(oND,lOD)
var aPD=_mz(z,'scroll-view',['class',7,'scrollY',1],[],e,s,gg)
var tQD=_v()
_(aPD,tQD)
var eRD=function(oTD,bSD,xUD,gg){
var fWD=_mz(z,'view',['bindtap',13,'class',1,'data-event-opts',2],[],oTD,bSD,gg)
var cXD=_mz(z,'news-card',['bind:__l',16,'class',1,'img',2,'link',3,'title',4,'vueId',5],[],oTD,bSD,gg)
_(fWD,cXD)
_(xUD,fWD)
return xUD
}
tQD.wxXCkey=4
_2z(z,11,eRD,e,s,gg,tQD,'item','index','index')
_(oND,aPD)
var hYD=_n('view')
_rz(z,hYD,'class',22,e,s,gg)
var oZD=_mz(z,'view',['bindtap',23,'class',1,'data-event-opts',2],[],e,s,gg)
var c1D=_oz(z,26,e,s,gg)
_(oZD,c1D)
_(hYD,oZD)
var o2D=_mz(z,'view',['bindtap',27,'class',1,'data-event-opts',2],[],e,s,gg)
...
var e6D=_mz(z,'refresh',['bind:__l',1,'bind:isRefresh',1,'class',2,'data-event-opts',3,'data-ref',4,'vueId',5],[],e,s,gg)
_(t5D,e6D)
var b7D=_mz(z,'click-circle',['bind:__l',7,'class',1,'data-ref',2,'vueId',3],[],e,s,gg)
_(t5D,b7D)
var o8D=_n('view')
_rz(z,o8D,'class',11,e,s,gg)
var x9D=_mz(z,'nav-tab',['bind:__l',12,'bind:changeTab',1,'class',2,'data-event-opts',3,'data-ref',4,'tabTitle',5,'vueId',6],[],e,s,gg)
_(o8D,x9D)
_(t5D,o8D)
var o0D=_mz(z,'swiper',['bindchange',19,'current',1,'data-event-opts',2,'style',3],[],e,s,gg)
var fAE=_v()
_(o0D,fAE)
var cBE=function(oDE,hCE,cEE,gg){
var lGE=_n('swiper-item')
var aHE=_mz(z,'scroll-view',['bindscrolltolower',27,'data-event-opts',1,'scrollY',2,'style',3],[],oDE,hCE,gg)
var eJE=_n('view')
_rz(z,eJE,'style',31,oDE,hCE,gg)
var bKE=_oz(z,32,oDE,hCE,gg)
_(eJE,bKE)
_(aHE,eJE)
var oLE=_n('view')
_rz(z,oLE,'class',33,oDE,hCE,gg)
var xME=_v()
_(oLE,xME)
var oNE=function(cPE,fOE,hQE,gg){
var cSE=_v()
_(hQE,cSE)
if(_oz(z,38,cPE,fOE,gg)){cSE.wxVkey=1
var oTE=_n('view')
_rz(z,oTE,'class',39,cPE,fOE,gg)
var lUE=_oz(z,40,cPE,fOE,gg)
_(oTE,lUE)
_(cSE,oTE)
}
cSE.wxXCkey=1
...
xME.wxXCkey=2
_2z(z,36,oNE,oDE,hCE,gg,xME,'item','index','index')
_(aHE,oLE)
var tIE=_v()
_(aHE,tIE)
if(_oz(z,41,oDE,hCE,gg)){tIE.wxVkey=1
var aVE=_n('view')
_rz(z,aVE,'class',42,oDE,hCE,gg)
var tWE=_oz(z,43,oDE,hCE,gg)
_(aVE,tWE)
_(tIE,aVE)
}
tIE.wxXCkey=1
...
fAE.wxXCkey=2
_2z(z,25,cBE,e,s,gg,fAE,'listItem','listIndex','listIndex')
_(t5D,o0D)
_(r,t5D)
return r
}
