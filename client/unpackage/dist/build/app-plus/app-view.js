...
/*v0.5vv_20190312_syb_scopedata*/
window.__wcc_version__ = 'v0.5vv_20190312_syb_scopedata';
...
$gwx = function(path, global) {
    ...
    function _gd(p, c, e, d) {
        ...
        for (var x = e[p].i.length - 1; x >= 0; x--) { if (e[p].i[x] && d[e[p].i[x]][c]) return d[e[p].i[x]][c] };
        for (var x = e[p].ti.length - 1; x >= 0; x--) { var q = _grp(e[p].ti[x], e, p); if (q && d[q][c]) return d[q][c] }
        var ii = _gapi(e, p);
        for (var x = 0; x < ii.length; x++) { if (ii[x] && d[ii[x]][c]) return d[ii[x]][c] }
        for (var k = e[p].j.length - 1; k >= 0; k--)
            if (e[p].j[k]) { for (var q = e[e[p].j[k]].ti.length - 1; q >= 0; q--) { var pp = _grp(e[e[p].j[k]].ti[q], e, p); if (pp && d[pp][c]) { return d[pp][c] } } }
    }

    function _gapi(e, p) {
        if (!p) return [];
        if ($gaic[p]) { return $gaic[p] };
        var ret = [],
            q = [],
            h = 0,
            t = 0,
    ...
    function _ic(p, ent, me, e, s, r, gg) {
        ...
        ent[me].j.push(x);
        if (x) {
            if ($ixc[x]) { _wp('-1:include:-1:-1: `' + p + '` is being included in a loop, will be stop.'); return; }
            $ixc[x] = true;
            try { ent[x].f(e, s, r, gg) } catch (e) {}
            $ixc[x] = false;
        } else { _wp(me + ':include:-1:-1: Included path `' + p + '` not found from `' + me + '`.') }
    }
    ...
    function _ev(dom) {
        ...
        if (dom.children) {
            do {
                changed = false;
                var newch = [];
                for (var i = 0; i < dom.children.length; i++) { var ch = dom.children[i]; if (ch.tag == 'virtual') { changed = true; for (var j = 0; ch.children && j < ch.children.length; j++) { newch.push(ch.children[j]); } } else { newch.push(ch); } }
                dom.children = newch;
            } while (changed);
            for (var i = 0; i < dom.children.length; i++) { _ev(dom.children[i]); }
        }
        return dom;
    }
    ...
    function gz$gwx_9() {
        ...
        (function(z) {
            ...
            Z([3, 'center'])
            Z([3, 'background-image:url(https://www.jixieclub.com:3002/images/jixieclub.jpg);'])
            Z([3, 'father'])
    ...
    function gz$gwx_12() {
        ...
        (function(z) {
            ...
            Z([3, 'myimg'])
            Z([3, 'https://www.jixieclub.com:3002/images/donation.jpg'])
        })(__WXML_GLOBAL__.ops_cached.$gwx_12);
    ...
    function gz$gwx_13() {
        ...
        (function(z) {
            ...
            Z([3, 'flex-sub    radius'])
            Z([3, 'myimg'])
            Z([3, 'https://www.jixieclub.com:3002/images/scan01.jpg'])
            ...
            Z(z[4])
            Z(z[5])
            Z([3, 'https://www.jixieclub.com:3002/images/scan02.jpg'])
            Z(z[7])
            Z(z[8])
            Z([3, '机械百宝箱'])
            Z(z[0])
            ...
            Z(z[4])
            Z(z[5])
            Z([3, 'https://www.jixieclub.com:3002/images/scan03.jpg'])
            Z(z[7])
            Z(z[8])
            Z([3, '机械创新设计研究中心'])
            Z([1, false])
    ...
    var nv_require = function() {
        ...
        return function(n) {
            return function() {
                ...
                try { if (!nom[n]) nom[n] = nnm[n](); return nom[n]; } catch (e) {
                    e.message = e.message.replace(/nv_/g, '');
...
setCssToHead([
    [2, 0]
], "Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:3881:1)", { path: "./app.wxss" })();

__wxAppCode__['app.wxss'] = setCssToHead([
    [2, 0]
], "Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:3881:1)", { path: "./app.wxss" });
