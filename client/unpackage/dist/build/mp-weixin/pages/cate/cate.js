    ...
    ["pages/cate/cate"], {
        "0f73": function(t, e, i) {
            ...
            (function(t) {
                ...
                var c = function() { return i.e("components/uni-grid/uni-grid").then(i.bind(null, "c663")) },
                    n = function() { return i.e("components/uni-grid-item/uni-grid-item").then(i.bind(null, "7021")) },
                    a = {
                        ...
                        methods: {
                            change: function(e) {
                                ...
                                this.$store.state.cateindex = i, console.log(this.list[i].text), this.$store.state.catetitle = this.list[i].text;
                                var c = this.list[i].text;
                                this.$store.state.cate = this.list[i].cate, t.navigateTo({ url: "../cate-detail/cate-detail?title=" + c })
                            }
                        },
                        components: { uniGrid: c, uniGridItem: n }
                    };
                e.default = a
